...
class HistoricoIndicadorController {
  ...
  /**
   * Render a form to be used for creating a new historicoindicador.
   * GET historicoindicadors/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing historicoindicador.
   * GET historicoindicadors/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
